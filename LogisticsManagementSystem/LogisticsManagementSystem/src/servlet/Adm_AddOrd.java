...
import DaoDemo.Adm_addord;


@WebServlet(value="/Adm_Addord.do")
public class Adm_AddOrd extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println(send_province);
		...
		Adm_addord addord=new Adm_addord();
...
//		String rece_province=addord.rece_siteid(province1);
		boolean flag=addord.addord(uid,send_province, rece_province, send_name, send_tel, 
				send_address, rece_name, rece_tel, rece_address, category, ord_weight, 
				ord_volume, ord_name, ord_num, insured, pay_method);
		if(flag) {
